...
const Testomonial = () => {
  ...
  return (
    <section ref={containerRef} className="text-gray-400 bg-gray-900y bg-primaryBlue body-font containerz">
        <div className="container px-5 py-24 mx-auto">
            <p className='text-lg font-semibold mb-2 text-center'>Reviewed by People</p>
            <h1 className="text-[2rem] font-bold title-font text-white mb-12 text-center">Clients' <span className='bg-primaryYellow px-2 py-1'>Testimonials</span></h1>
